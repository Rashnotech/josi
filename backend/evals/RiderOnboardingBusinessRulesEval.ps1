...
Assert-Contains 'app/Http/Controllers/Api/V1/DriverProfileController.php' "Rule::unique('users', 'phone')->ignore" 'Rider profile phone uniqueness'
Assert-Contains 'app/Http/Controllers/Api/V1/DriverProfileController.php' "`$userUpdates['name'] = trim" 'Rider profile syncs user display name'
Assert-Contains 'app/Http/Controllers/Api/V1/DriverProfileController.php' "`$userUpdates['phone'] = `$data['phone']" 'Rider profile syncs user phone'
