...
Assert-Contains '.env.example' 'SESSION_DRIVER=database' 'Database session driver for Filament'
...
Assert-Contains 'database/migrations/2026_06_14_000002_create_sessions_table.php' "Schema::create('sessions'" 'Database sessions table migration'
Assert-Contains 'database/migrations/2026_06_14_000002_create_sessions_table.php' "string('id')->primary()" 'Sessions table primary id'
Assert-Contains 'database/migrations/2026_06_14_000002_create_sessions_table.php' "integer('last_activity')->index()" 'Sessions table last activity index'
...
Assert-Contains 'docs/database-setup.md' 'Confirm `sessions` exists before Filament admin login testing.' 'Filament sessions table documented'
