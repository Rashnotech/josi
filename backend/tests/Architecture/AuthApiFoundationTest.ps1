...
Assert-Contains 'database/migrations/2026_06_04_000018_create_permission_role_table.php' "Schema::create('permission_role'" 'Permission role pivot'
Assert-Contains 'database/migrations/2026_06_04_000019_create_role_user_table.php' "Schema::create('role_user'" 'Role user pivot'
