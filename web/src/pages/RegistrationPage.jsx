  ...
  return (
    <main className="bg-white">
      <section className="py-10 sm:py-14 lg:py-16">
        <div className="section-shell grid min-w-0 gap-9 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1fr)] lg:items-start lg:gap-14">
          ...
          <form className="w-full min-w-0 max-w-full overflow-hidden rounded-lg border border-line bg-white p-5 shadow-soft sm:p-7">
            ...
            <div className="mt-6 grid gap-4">
              <label className="grid min-w-0 gap-2">
                ...
                <input
                  className="focus-ring h-12 w-full min-w-0 rounded-lg border border-line px-4 font-semibold"
              ...
              <label className="grid min-w-0 gap-2">
                ...
                <select className="focus-ring h-12 w-full min-w-0 rounded-lg border border-line bg-white px-4 font-semibold">
