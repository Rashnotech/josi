...
- Bundled Urbanist font weights and bundled Josi logo asset.
...
- Urbanist is bundled from the font project under the SIL Open Font License in `assets/fonts/Urbanist-OFL.txt`.
